    ...
    <div class="bg-white shadow-md rounded text-center px-8 w-1/4 pt-6 pb-8 mb-4 flex flex-col">
      ...
      <div class="flex items-stretch w-full m-auto my-4">
        ...
        <div v-if="madeChoice">
         ...
         <button @onSubmit="loginGoogle" type="button" class="google-button">
           <a href="http://localhost:3333/login/google">
          ...
          <span class="google-button__text">S'inscrire avec Google</span>
          </a>
        </button>
        </div>
